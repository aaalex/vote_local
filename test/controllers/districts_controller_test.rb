...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { district_type: @district.district_type, name: @district.name, position: @district.position }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { district_type: @district.district_type, name: @district.name, position: @district.position }
    assert_redirected_to district_path(assigns(:district))
  end
